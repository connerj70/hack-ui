...
export default function Root() {
  ...
  return (
    <>
      ...
      <div className="p-8 bg-green-600 text-white flex flex-col min-h-96 w-100 mt-20 md:mt-6 justify-center items-center">
        <div className="w-full md:flex-row flex-col mb-4 flex justify-between xl:justify-around items-center">
          <div className="w-1/2 xl:w-1/3 mt-6">
            <h3 className="font-serif text-2xl">Shared Data Standard.</h3>
          </div>
          <div className="w-1/2 xl:w-1/3 mt-6">
            <h3 className="font-serif text-2xl">IoT Network of Connected Devices.</h3>
          </div>
        </div>
        <div className="w-full flex md:flex-row flex-col justify-between xl:justify-around items-center">
          <div className="w-1/2 xl:w-1/3 mt-6">
            <h3 className="font-serif text-2xl">Base Layer for a Smart Economic Stack.</h3>
          </div>
          <div className="w-1/2 xl:w-1/3 mt-6">
            <h3 className="font-serif text-2xl">Authenticated Inventory Tracking System.</h3>
          </div>
        </div>
      </div>
